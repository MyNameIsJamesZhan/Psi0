...
DATA_ROOT="${DATA_ROOT:-/data2/yunkai/HumanoidEverywhere/third_party/simple-3dgs/data/training/bedroom_v2_move_cup_psi0}"
...
exp="${exp:-bedroom-move-cup-past$NUM_PAST_FRAMES}"
