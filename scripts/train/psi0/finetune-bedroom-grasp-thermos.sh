...
DATA_ROOT="${DATA_ROOT:-/data2/yunkai/HumanoidEverywhere/third_party/simple-3dgs/data/training/bedroom_v2_grasp_thermos_psi0}"
...
NUM_PAST_FRAMES="${NUM_PAST_FRAMES:-10}"
exp="${exp:-psi0_bedrppm_grasp_thermos_past=$NUM_PAST_FRAMES}"
...
# Total training steps (cosine schedule horizon + loop termination). When
# resuming, the step counter is restored, so this is the ABSOLUTE stop step
# (e.g. resume at 12000 with MAX_STEPS=22000 trains 10000 more steps).
